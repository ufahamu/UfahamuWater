...
$authorsql_conditions= " where p.post_type = 'event' and p.post_status='publish' and p.ID = pm.post_id";
}
...
$header_top .= ",comments_data,rating_data";
	...
	if(strtolower(get_option('post_type_export')) == CUSTOM_POST_TYPE2)
		{
			$content_1 .=",$reg_desc,$reg_fees,$st_date,$st_time,$end_date,$end_time"; 
		}
	$content_1 .= ",$newarray,$rating ";
	echo $content_1." \r\n";
	}			
}else
{
