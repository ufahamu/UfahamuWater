...
foreach($results as $_results)
 {
	$content=  "$_results->city_id,$_results->country_id,$_results->ptype,$_results->zones_id,$_results->cityname,$_results->lat,$_results->lng,$_results->scall_factor,$_results->sortorder,$_results->is_zoom_home,'',$_results->is_default,$_results->geo_address";
	 echo $content." \r\n";
 }
 ?>