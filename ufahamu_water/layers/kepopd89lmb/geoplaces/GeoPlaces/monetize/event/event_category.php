...
if($catinfo) {
	...
	foreach($catinfo as $catinfo_obj)
	{
		...
		?>
		 ...
		 <div class="form_cat" ><label><input type="checkbox" name="category[]" id="category_<?php echo $counter; ?>" value="<?php if($cp != ""){ echo $termid.",".$catprice->term_price; }else{ echo $termid.",".'0'; }?>" class="checkbox" <?php if(isset($place_cat_arr) && in_array($termid,$place_cat_arr)){echo 'checked="checked"'; }?>  onclick="event_packages('<?php echo $catinfo_obj->term_id; ?>',this.form,'<?php echo $cp; ?>')"/>&nbsp;<?php if($cp != ""){ echo $name."<span style='color:#990000;'> (".display_amount_with_currency($cp).")</span> "; }else{ echo $name."<span> (".display_amount_with_currency('0').")</span> "; } ?></label></div>
		...
		<?php
		 ...
		 ?>
			<div class="form_cat" style="margin-left:15px;"><label><input type="checkbox" name="category[]" id="category_<?php echo $counter; ?>" value="<?php if($cp != ""){ echo $termid.",".$catprice->term_price; }else{ echo $termid.",".'0'; }?>" class="checkbox" <?php if(isset($place_cat_arr) && in_array($termid,$place_cat_arr)){echo 'checked="checked"'; }?>  onclick="event_packages('<?php echo $catprice->term_id; ?>',this.form,'<?php echo $catprice->term_price; ?>')"/>&nbsp;<?php if($cp != ""){ echo $name."<span style='color:#990000;'> (".display_amount_with_currency($cp).")</span>"; }else{ echo $name."<span style='color:#990000;'> (".display_amount_with_currency('0').")</span>"; } ?></label></div>
		<?php }
		...
		$cp = $catprice->term_price; 
			if((isset($_REQUEST['category']) && $_REQUEST['category'] != '') || (isset($_SESSION['event_info']['category']) && $_SESSION['event_info']['category'] != '') ) { 
