        ...
        <form method="get"  action="<?php echo bloginfo('url')."/"; ?>" name="searchform" onsubmit="return sformcheck();">
          <div class="advanced_left">
           <p> <label><?php echo SEARCH;?></label>
              <input class="adv_input" name="s" id="adv_s" type="text" onfocus="if(this.value=='<?php echo SEARCH;?>') this.value='';" onblur="if(this.value=='') this.value='<?php echo SEARCH;?>';" value="<?php echo SEARCH;?>" />
