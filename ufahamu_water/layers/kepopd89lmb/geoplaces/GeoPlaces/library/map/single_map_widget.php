...
$tooltip_message = '<img src="'.templ_thumbimage_filter($prdimage[0],'&amp;w=60&amp;h=60&amp;zc=1&amp;q=80').'"  style="float:left;margin:0 10px 5px 0;" alt="" /></div>';
$tooltip_message .= '<div style="float:left;width:150px;"><a href="'.get_permalink($post->ID).'" class="ptitle">'.$post_title.'</a>';
if($post->post_type == CUSTOM_POST_TYPE1) {
