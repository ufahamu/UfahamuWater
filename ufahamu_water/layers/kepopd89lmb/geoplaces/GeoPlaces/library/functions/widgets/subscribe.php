...
?>
    ...
    <?php } ?>
       ...
       <input type="text" class="field" value="<?php _e('Enter Email Address','templatic')?>" onfocus="if (this.value == '<?php _e('Enter Email Address','templatic')?>') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php _e('Enter Email Address','templatic')?>';}" name="email"/>
