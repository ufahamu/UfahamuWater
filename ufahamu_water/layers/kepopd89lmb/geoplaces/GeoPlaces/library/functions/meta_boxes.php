...
/* function to perform widget results */
	...
	function admin_init(){
		add_meta_box("Claim post", "Claim post", "meta_options", CUSTOM_POST_TYPE1, "normal", "high");
		add_meta_box("Claim post", "Claim post", "meta_options", CUSTOM_POST_TYPE2, "normal", "high");
