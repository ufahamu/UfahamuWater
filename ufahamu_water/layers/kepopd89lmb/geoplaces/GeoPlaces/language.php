...
define('ALPHA_ORDER_TEXT',__('Alphabetical','templatic'));
define('LATEST_ORDER_TEXT',__('Latest published','templatic'));
define('RANDOM_ORDER_TEXT',__('Random','templatic'));
...
define('TAGS_TEXT',__('<strong>Tags: </strong>','templatic'));
